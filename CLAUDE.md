...
This file mirrors the canonical contributor and design contract in `AGENTS.md` so Claude Code follows the same architecture and interface decisions. Read it before changing a page, shared shell, build script, or deployment workflow.
